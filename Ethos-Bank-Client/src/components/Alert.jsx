      ...
      {props.show && <motion.div
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-r from-cyan-400 via-sky-600 to-sky-700 text-white p-6 rounded-lg  max-w-lg shadow-xl cursor-default relative overflow-hidden h-[40vh] w-[50%] flex justify-evenly items-center"
          >
