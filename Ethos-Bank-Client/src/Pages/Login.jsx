      ...
      <div className="h-[75%] w-[60%] bg-white rounded-xl shadow-2xl flex overflow-hidden">
        ...
        <div className="h-full w-[20%] bg-gradient-to-r from-sky-500 to-blue-900 flex items-center justify-center gap-4">
            <div className="h-[90%] w-[12%] bg-white/30 rounded-3xl flex justify-center py-[2.5vh]">
                <div id="slider" className=" h-[0.8rem] w-[0.8rem] rounded-full bg-white duration-[600ms] ease-linear"></div>
            </div>
            <div className="h-[90%] flex flex-col items-start justify-between py-[1.5vh]">
                <p className={`text-lg font-semibold text-white ${index !== 1 ? "text-opacity-30" : ""} duration-[600ms] ease-linear`}>Log In</p>
                <p className={`text-lg font-semibold text-white ${index !== 2 ? "text-opacity-30" : ""} duration-[600ms] ease-linear`}>Verify</p>
                <p className={`text-lg font-semibold text-white ${index !== 3 ? "text-opacity-30" : ""} duration-[600ms] ease-linear`}>Confirm</p>
            </div>
        </div>
        ...
        <div id="login" className="h-full w-[80%] flex flex-col items-center duration-[600ms] ease-linear">
          <div className="min-h-full w-full flex justify-center items-center">
            ...
            <div className="h-full w-[70%] flex flex-col justify-center items-center">
              ...
              <div className="flex w-full  h-[20%] items-center justify-evenly px-5">
                <button className="py-4 rounded-lg shadow-inner text-lg font-semibold w-[38%] bg-gray-200 hover:bg-blue-600 hover:text-gray-200 duration-200 ease-linear" onClick={()=>{navigate(-1)}}>
                  CANCEL
                </button>
                <button
          ...
          <div className="flex w-full  h-[20%] items-center justify-evenly px-5">
                <button className="py-4 rounded-lg shadow-inner text-lg font-semibold w-[38%] bg-gray-200 hover:bg-blue-600 hover:text-gray-200 duration-200 ease-linear" onClick={prevSlide}>
                  CANCEL
                </button>
                <button
                  className="py-4 rounded-lg shadow-inner text-lg font-semibold w-[38%] bg-gray-200 hover:bg-blue-600 hover:text-gray-200 duration-200 ease-linear"
