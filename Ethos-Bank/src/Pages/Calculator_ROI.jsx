  ...
  const result = () => {
    ...
    return (
      <div className=" h-4/5 w-1/2 bg-white rounded-2xl shadow-md">
        <div className=" h-1/5 w-full bg-sky-600 rounded-t-2xl flex justify-center items-center text-2xl font-semibold font-[Poppins] text-white">
        ...
        <div className="flex justify-start items-center flex-col gap-8 pt-9">
          ...
          <div className="w-full h-[25vh] flex justify-around items-center">
            <div className="h-4/5 bg-gray-100 w-2/5 rounded-2xl shadow-md flex flex-col justify-center items-center">
              <p className=" text-lg font-bold font-[Poppins] text-sky-600">Return On</p>
              <p className=" text-lg font-bold font-[Poppins] text-sky-600">Investement</p>
              <p className="text-xl font-semibold font-[Poppins] pt-6">{roi.toFixed(2)}%</p>
            </div>
            <div className="h-4/5 bg-gray-100 w-2/5 rounded-2xl shadow-md flex flex-col justify-center items-center">
              <p className=" text-lg font-bold font-[Poppins] text-sky-600">Annual</p>
              <p className=" text-lg font-bold font-[Poppins] text-sky-600">ROI</p>
              <p className="text-xl font-semibold font-[Poppins] pt-6">{annualRoi.toFixed(2)}%</p>
            </div>
          </div>
        </div>
      </div>
